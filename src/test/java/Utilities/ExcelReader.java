...
public class ExcelReader {
	...
	// returns the data from a cell
	//This method is depleted as new POI jar after 4.0.0 doenst support this method
/*	public String getCellData(String sheetName,int colNum,int rowNum){
		try{
			if(rowNum <=0)
				return "";
  ...
  // find whether sheets exists	
	...
	public static void main(String arg[]) throws IOException{
		...
		ExcelReader datatable = null;
			 ...
			 datatable = new ExcelReader("/Users/surbhi/Documents/Learning_Selenium/LBS-Automation/src/test/resources/excel/testdata.xlsx");
